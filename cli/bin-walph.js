...
function getPlatformBinary() {
	...
	const binaryName = `walph-${platformKey}-${archKey}${ext}`;
...
function main() {
	...
	if (!existsSync(binaryPath)) {
		...
		const srcPath = join(__dirname, "src", "walph", "index.ts");
		...
		console.error("Run 'bun run build:walph' to compile the binary for your platform.");
